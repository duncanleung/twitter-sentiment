...
/***/ function(module, exports, __webpack_require__) {
	...
	var TwitterStream = React.createClass({
	  ...
	  getInitialState: function getInitialState() {
	    return { collectedTweets: [{ created_at: 'Sat Dec 26 17:54:10 +0000 2015',
	        ...
	        retweeted_status: { created_at: 'Sat Dec 26 17:01:56 +0000 2015',
	...
	var TweetList = React.createClass({
	  ...
	  render: function render() {
	    ...
	    var tweets = this.props.collectedTweets.map(function (tweet) {
	      return React.createElement(TweetCard, { tweet: tweet });
	    });
